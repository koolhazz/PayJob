...
//发送字节映射表
BYTE CEncryptDecrypt::m_SendByteMap[256]=				
{
...
//接收字节映射表
BYTE CEncryptDecrypt::m_RecvByteMap[256]=				
{
...
//解密数据
int CEncryptDecrypt::DecryptBuffer(NETInputPacket *pPacket)
{
	//效验参数
	BYTE *pcbDataBuffer = (BYTE *)pPacket->packet_buf() + NETOutputPacket::PACKET_HEADER_SIZE;
	WORD wDataSize = pPacket->GetBodyLength() - 7;
...
//映射接收数据
BYTE CEncryptDecrypt::MapRecvByte(BYTE const cbData)
{
...
//映射发送数据
BYTE CEncryptDecrypt::MapSendByte(BYTE const cbData)
{
